...
var GraphQLRelayDirectiveInstance = new GraphQLDirective(require('././GraphQLRelayDirective'));
...
var RelayQLDirective = function () {
  function RelayQLDirective(context, ast) {
    ...
    var schemaDirective = directiveName === require('././GraphQLRelayDirective').name ? GraphQLRelayDirectiveInstance : context.schema.getDirective(directiveName);
    if (!schemaDirective) {
