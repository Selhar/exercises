...
function dumpRelayRecordSourceProxy(proxy) {
  ...
  console.log('Modified Records: ', JSON.parse((0, _stringify2['default'])(mutatorSources[0])));
  console.log('Original Records: ', JSON.parse((0, _stringify2['default'])(mutatorSources[1])));
  console.groupEnd();
}
