...
var RelayMarkSweepStore = function () {
  ...
  RelayMarkSweepStore.prototype.check = function check(selector) {
    return require('./RelayAsyncLoader').check(this._recordSource, this._recordSource, selector);
  };
  ...
  RelayMarkSweepStore.prototype.lookup = function lookup(selector) {
    var snapshot = require('./RelayReader').read(this._recordSource, selector, require('./RelayModernRecord'));
    if (process.env.NODE_ENV !== 'production') {
  ...
  RelayMarkSweepStore.prototype._updateSubscription = function _updateSubscription(subscription) {
    ...
    var _RelayReader$read = require('./RelayReader').read(this._recordSource, snapshot, require('./RelayModernRecord')),
